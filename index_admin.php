...
<head>
    ...
    <style>
        ...
        .a_5:hover{
            background-color: rgb(148, 110, 39);
            border-width: 0px;
        }
    </style>
</head>
<body class="body_1">
    ...
    if($result = mysqli_query($conn,$sql_limit)){//mysqli_query下達SQL語法，將結果傳回result
        ...
        print "<th style='width:200px'>留言管理</th>";
        print "<tr>";
        ...
        print "<a href='edit_message.php?id=".$arr['mID']."' class='a_5'>修改</a>";
        print "<a href='delete_message.php?id=".$arr['mID']."' class='a_5'>刪除</a>";
        print "</td>";
    ...
    print "<div >";
    print "<a href='?action=out' class='input_4' style='float:left' >登出管理</a>";
    if($num_page>1){
        print "<a href='index_admin.php?page=1' class='a_10'>第一頁&nbsp</a>";
        print "<a href='index_admin.php?page=". ($num_page-1) . "' class='a_10'>上一頁&nbsp</a>";
    }
    
    if($num_page<$total_pages){
        print "<a href='index_admin.php?page=". ($num_page+1) . "' class='a_10'>下一頁&nbsp</a>";
        print "<a href='index_admin.php?page=". $total_pages . "' class='a_10'>最後一頁</a>";
    }
    print "</div>";
    ...
    print "<div style='border-radius:0px 0px 10px 10px'>";
            ...
            for($i=1;$i<=$total_pages;$i++){    
                    if($i==$num_page){
                        ...
                        print "<a href='index_admin.php?page=$i' class='a_2'>$i</a>";
                    }  
            }
            print "</div>";
    }
